...
const SEGMENTS: { name: string; lineType: 'UP' | 'DOWN' }[] = [
  ...
  { name: 'GZB–HPU', lineType: 'UP' },
  { name: 'GZB–HPU', lineType: 'DOWN' },
  { name: 'SRE–MZN', lineType: 'UP' },
  { name: 'SRE–MZN', lineType: 'DOWN' },
  { name: 'MZN–MTC', lineType: 'UP' },
  { name: 'MZN–MTC', lineType: 'DOWN' },
